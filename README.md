...
*   **I pulled latest, but my notebook still looks old.**
    *   Make sure you opened the notebook from this repo path: `Invokeai_in_google_colab.ipynb`.
    *   If you use a copy in Google Drive, re-open from GitHub or copy the updated notebook into Drive again.
    *   In the startup cell, look for `Notebook revision: cloudflare-tunnel-fixes-v2` in output to confirm you are on the updated version.
